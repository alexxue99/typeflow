...
export function ModeSettings({ mode, settings, setSettings, onRestart }: Props) {
  ...
  return <details className="mode-settings">
    ...
    <div className="mode-settings-grid">
      ...
      {mode === "cadence" && <label className="check-row"><input type="checkbox" checked={settings.cadenceBlockSound} onChange={(e) => update("cadenceBlockSound", e.target.checked)} /> Play sound when next block is available</label>}
