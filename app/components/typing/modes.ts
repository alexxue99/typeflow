...
export const MODES: { id: TypingMode; icon: ReactNode; title: string; header: string, home: string; help: string}[] = [
  ...
  { id: "workout", icon: "↟", title: "Workout", header: "Workout.",
    home: "Focused bursts to strengthen one finger.", help: "A workout mode to train specific fingers. Choose the finger you want to practice in Settings. Letters are generated to focus on the selected finger." },
  { id: "practice", icon: "✦", title: "Practice", header: "Practice.",
    home: "Exercises shaped by your Flow results.", help: "A mode for improving your performance on your slowest letters and bigrams, with text tailored to your needs based on analytics collected during Flow sessions." },
];
