...
import { filterUserBests, readUserStatsSession } from "../app/lib/userStats";
...
describe("user stats filters", () => {
  const bests = [best("flow", { type: "timed", amount: 15 }), best("flow", { type: "words", amount: 25 }), best("zen", { type: "blocks", amount: 25 }), best("keyboardshot", { type: "targets", amount: 50 })];
